...
class PrimaryReadAndCompleteScreen extends React.Component {
  constructor(props) {
    super(props);
  ...
  componentDidMount(): void {
    if (this.checkScriptType()) {
      ...
      const question = currentScriptItem.content;
  ...
  checkScriptType = () => {
    ...
    if (currentScriptItem && currentScriptItem.type === 'read_and_complete') {
      return true;
    }
  ...
  next = () => {
    ...
    const {setMaxCorrect, increaseScore} = this.props;
