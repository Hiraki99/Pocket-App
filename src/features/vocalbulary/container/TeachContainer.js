...
class TeachContainer extends React.PureComponent {
  renderHeaderSpeak = () => {
  ...
  renderItemSpeak = ({item, index}) => {
    return (
      <TouchableOpacity
        activeOpacity={0.7}
        onPress={() => {
          navigator.navigate('DetailLecture', {params: item});
        }}>
        <RowContainer
          backgroundColor={colors.white}
          paddingVertical={20}
    ...
    return (
      <FlexContainer>
        <FlatList
          ...
          ListHeaderComponent={this.renderHeaderSpeak}
          ListEmptyComponent={this.renderEmptyList}
          renderItem={this.renderItemSpeak}
